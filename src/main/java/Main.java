 ...
 */
public class Main {
    public static final int fakeRecordsAmount = 25000;
    public static final boolean batchExecutionAllowed = false;
    public static final boolean hintSpeedUpAllowed = true;
    public static void main(String[] args){
        ...
        System.out.println("\n");
        Demo demo = new Demo(db,batchExecutionAllowed&&db.isBatchExecutionSupported(),hintSpeedUpAllowed).setFakeRecordsAmountRequired(fakeRecordsAmount);
